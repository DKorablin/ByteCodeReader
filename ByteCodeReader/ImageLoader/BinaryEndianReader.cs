...
namespace AlphaOmega.Debug
{
	...
	{
		private readonly Utils.Endian _endiannes;
		...
		public BinaryEndianReader(Stream input,Utils.Endian endianness)
			: base(input)
		{
		...
		public static BinaryReader CreateReader(Utils.Endian endiannes, MemoryStream input)
		{
			if(BitConverter.IsLittleEndian == (endiannes == Utils.Endian.Little))
		...
		public override Decimal ReadDecimal()
		{
			...
			Utils.AdjustEndianness(typeof(Decimal), bytes, this._endiannes);
		...
		public override Double ReadDouble()
		{
			...
			Utils.AdjustEndianness(typeof(Double), bytes, this._endiannes);
		...
		public override Int16 ReadInt16()
		{
			...
			Utils.AdjustEndianness(typeof(Int16), bytes, this._endiannes);
		...
		public override Int32 ReadInt32()
		{
			...
			Utils.AdjustEndianness(typeof(Int32), bytes, this._endiannes);
		...
		public override Int64 ReadInt64()
		{
			...
			Utils.AdjustEndianness(typeof(Int64), bytes, this._endiannes);
		...
		public override Single ReadSingle()
		{
			...
			Utils.AdjustEndianness(typeof(Single), bytes, this._endiannes);
		...
		public override UInt16 ReadUInt16()
		{
			...
			Utils.AdjustEndianness(typeof(UInt16), bytes, this._endiannes);
		...
		public override UInt32 ReadUInt32()
		{
			...
			Utils.AdjustEndianness(typeof(UInt32), bytes, this._endiannes);
		...
		public override UInt64 ReadUInt64()
		{
			...
			Utils.AdjustEndianness(typeof(UInt64), bytes, this._endiannes);
