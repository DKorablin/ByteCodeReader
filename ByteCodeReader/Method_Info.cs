...
namespace AlphaOmega.Debug
{
	...
	public class Method_Info
	{
		...
		/// <remarks>The constant_pool entry at that index must be a CONSTANT_Utf8_info (§4.4.7) structure representing either one of the special method names (§2.9) &lt;init&gt; or &lt;clinit&gt;, or a valid unqualified name (§4.2.2) denoting a method.</remarks>
		public Utf8Row name { get { return this.File.constant_pool.Utf8[this.Method.name_index]; } }

		/// <summary>The value of the descriptor_index item must be a valid index into the constant_pool table. The constant_pool entry at that index must be a CONSTANT_Utf8_info (§4.4.7) structure representing a valid method descriptor (§4.3.3).</summary>
		...
		internal Method_Info(ClassFile file, Jvm.method_info method, AttributeReference[] attributes)
		{
			this._file = file;
			this._method = method;
