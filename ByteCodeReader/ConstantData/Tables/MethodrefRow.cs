...
namespace AlphaOmega.Debug.ConstantData
{
	...
	public class MethodrefRow : BaseRow<Jvm.CONSTANT>
	{
		...
		/// <summary>
		/// If the name of the method of a CONSTANT_Methodref_info structure begins with a '&lt;' ('\u003c'), then the name must be the special name &lt;init&gt;, representing an instance initialization method (§2.9).
