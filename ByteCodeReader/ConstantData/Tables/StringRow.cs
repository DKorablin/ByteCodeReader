...
namespace AlphaOmega.Debug.ConstantData
{
	...
	public class StringRow : BaseRow<Jvm.CONSTANT>
	{
		...
		/// <summary>The constant_pool entry at that index must be a <see cref="Jvm.CONSTANT_Utf8_info"/> structure (§4.4.7) representing the sequence of Unicode code points to which the String object is to be initialized</summary>
