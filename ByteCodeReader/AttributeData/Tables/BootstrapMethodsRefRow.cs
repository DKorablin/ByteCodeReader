...
namespace AlphaOmega.Debug.AttributeData
{
	...
	public class BootstrapMethodsRefRow : BaseRow<String>
	{
		...
		/// The constant_pool entry at that index must be a <see cref="Jvm.CONSTANT_MethodHandle_info"/> structure (§4.4.8).
		/// </summary>
		/// <remarks>
		...
		/// The constant_pool entry at that index must be a <see cref="Jvm.CONSTANT_String_info"/>, <see cref="Jvm.CONSTANT_Class_info"/>, <see cref="Jvm.CONSTANT_Integer_info"/>, <see cref="Jvm.CONSTANT_Long_info"/>, <see cref="Jvm.CONSTANT_Float_info"/>, <see cref="Jvm.CONSTANT_Double_info"/>, <see cref="Jvm.CONSTANT_MethodHandle_info"/>, or <see cref="Jvm.CONSTANT_MethodType_info"/> structure (§4.4.3, §4.4.1, §4.4.4, §4.4.5, §4.4.8, §4.4.9).
		/// </summary>
