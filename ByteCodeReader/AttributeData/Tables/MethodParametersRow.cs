...
namespace AlphaOmega.Debug.AttributeData
{
	...
	public class MethodParametersRow : BaseRow<String>
	{
		...
		/// <remarks>This is not a constraint which a Java Virtual Machine implementation must enforce during format checking (§4.8). The task of matching parameter descriptors in a method descriptor against the items in the parameters array below is done by the reflection libraries of the Java SE platform.</remarks>
