...
namespace AlphaOmega.Debug
{
	...
	public struct Utils
	{
		...
		internal static void AdjustEndianness(Type type, Byte[] data, Utils.Endian endian, Int32 startOffset = 0)
		{
			if(BitConverter.IsLittleEndian == (endian == Utils.Endian.Little))
				return;
			...
			{
			default:
				Array.Reverse(data, startOffset, Utils.SizeTypes[code]);
				break;
			...
			case TypeCode.Object:
				foreach(FieldInfo field in type.GetFields())
				{
					...
					}*/ else
					{
						...
						Utils.AdjustEndianness(fieldType, data, endian, fieldOffset);
					}
				}
				break;
			}
